...
import { selectBestServices } from '../store/bestServicesSlice';
...
const HealthTipsAndGuidance: React.FC = () => {
  ...
  return (
    <section
      className={
        'container mx-auto flex flex-col justify-center items-center gap-10'
      }
    >
      <div
        className={'pt-10 pb-5 flex flex-col justify-center items-center gap-5'}
      >
      ...
      <div className={'flex flex-col gap-4 w-full'}>
        {bestServices.map((_) => {
          return (
            <Card className={'w-full bg-gray-200'} key={_.id}>
