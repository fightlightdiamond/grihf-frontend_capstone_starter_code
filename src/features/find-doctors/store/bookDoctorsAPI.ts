...
import {
    TDoctor,
    FindDoctorsError, IBookDoctor,
} from "../types";
import {_bookDoctor, _cancelBookDoctor, _findDoctors, _getBookDoctors} from "../mock/_DATA_";
...
>(
    "bookDoctor/fetch",
    async (bookDoctor: IBookDoctor, thunkApi) => {
...
export const cancelBookDoctor = createAsyncThunk<
    ...
    { rejectValue: FindDoctorsError }
>(
    "cancelBookDoctor/fetch",
    async (payload: ICancelPayload, thunkApi) => {
