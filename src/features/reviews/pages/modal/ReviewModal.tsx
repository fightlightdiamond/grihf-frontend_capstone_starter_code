import {Button, Label, Modal, ModalBody, ModalHeader, Rating, RatingStar, Textarea, TextInput} from "flowbite-react";
...
const ReviewModal = ({userId, bookDoctorId, openModal, setOpenModal}: IReviewModelProps) => {
    const {
        register,
        handleSubmit,
        formState: {errors},
        ...
        <ModalBody>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                    ...
                    <Textarea
                        {...register("review")}
                        id="review" placeholder="Leave a comment..." required rows={4}/>
                </div>
                <div>
                    ...
                    <Rating id={'rating'}>
                        {
                            ...
                            <RatingStar key={indexRating} onClick={
                                () => handleRatingClick(indexRating)
                            } className={'hover:text-yellow-400'} filled={rating>indexRating-1}/>)
                        }
                    </Rating>
                </div>
